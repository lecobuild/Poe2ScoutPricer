// API/IPoe2ScoutApi.cs
using Poe2ScoutPricer.API.Models;

namespace Poe2ScoutPricer.API
{
    public interface IPoe2ScoutApi
    {
        Task<ApiResponse<CategoryResponse>> GetCategoriesAsync();
        Task<ApiResponse<UniqueItemsResponse>> GetUniqueItemsAsync(string category, string search = "", int page = 1, int perPage = 25, string league = "Standard");
        Task<ApiResponse<CurrencyItemsResponse>> GetCurrencyItemsAsync(string category, string search = "", int page = 1, int perPage = 25, string league = "Standard");
        Task<ApiResponse<List<League>>> GetLeaguesAsync();
        Task<ApiResponse<UniqueBaseItemsResponse>> GetUniqueBaseItemsAsync(string search = "", bool showUnChanceable = false, string sortedBy = "price", int page = 1, int perPage = 25, string league = "Standard");
        Task<ApiResponse<UniquesByBaseNameResponse>> GetUniquesByBaseNameAsync(string baseName, string league);
        Task<ApiResponse<CurrencyItemByIdResponse>> GetCurrencyItemByIdAsync(string apiId, string league);
        Task<ApiResponse<string>> GetItemHistoryAsync(int itemId, string league, int logCount);
    }
}
...
namespace Poe2ScoutPricer.API
{
    public class Poe2ScoutApiClient : IPoe2ScoutApi, IDisposable
    {
            ...
            string league = "Standard")
        {
            ...
            var url = $"/items/unique/{HttpUtility.UrlEncode(category)}" + BuildQueryString(queryParams);
            ...
            string league = "Standard")
        {
            ...
            var url = $"/items/currency/{HttpUtility.UrlEncode(category)}" + BuildQueryString(queryParams);
        ...
        public async Task<ApiResponse<UniquesByBaseNameResponse>> GetUniquesByBaseNameAsync(string baseName, string league)
        {
            ...
            var url = $"/items/uniquesByBaseName/{HttpUtility.UrlEncode(baseName)}" + BuildQueryString(queryParams);
        ...
        public async Task<ApiResponse<CurrencyItemByIdResponse>> GetCurrencyItemByIdAsync(string apiId, string league)
        {
            ...
            var url = $"/items/currencyById/{HttpUtility.UrlEncode(apiId)}" + BuildQueryString(queryParams);
